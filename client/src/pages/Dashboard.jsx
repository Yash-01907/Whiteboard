      ...
      <div className="min-h-screen bg-[#F9FAFB] text-gray-900">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:flex flex-col">
                  <span className="text-sm font-semibold text-gray-900 leading-none">Whiteboard.io</span>
                  <span className="text-xs text-gray-500 mt-1">{user?.username}'s Workspace</span>
              </div>
            </div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Recent Boards</h1>
              <p className="text-gray-500 text-sm mt-1">Pick up where you left off or start fresh.</p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            >
              ...
              <p className="font-medium text-gray-600 group-hover:text-blue-700">New Board</p>
            </div>
            ...
            {filteredBoards.map((board) => (
              ...
              >
                ...
                <div className="h-32 w-full bg-gray-50 border-b border-gray-100 relative overflow-hidden group-hover:bg-gray-100/80 transition-colors">
                  ...
                  {/* Role Badge */}
                  <span className={`absolute top-3 left-3 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide rounded-full border shadow-sm ${
                    board.owner === user?._id 
                      ? 'bg-white text-blue-700 border-blue-100' 
                      : 'bg-white text-purple-700 border-purple-100'
                  }`}>
                    {board.owner === user?._id ? "Owner" : "Collab"}
                  </span>
